...
import { useVerifyCodeMutation } from "@/app/redux/api/auth/VerifyCodeApi";
...
const ResetUserverifyCode = () => {
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    ...
    try {
      const res = await verifyCode({ code: codeString, email }).unwrap();
      if (res?.success) {
        Swal.fire({
          icon: "success",
          title: res?.message,
...
export default ResetUserverifyCode;
